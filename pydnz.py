...
class Request():
    def __init__(self, query=None, fields=None, facets=None, sort=None, direction=None, 
                 per_page=None, page=None, facets_per_page=None, key='', wild=None):
    ...
    def _multiValueFormatter(self, param_name, values):
        ...
        if isinstance(values, basestring): raise ValueError("Multi-value parameters should not be strings.")
